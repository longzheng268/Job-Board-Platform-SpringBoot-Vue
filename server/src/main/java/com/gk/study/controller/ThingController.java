...
public class ThingController {
    ...
    @RequestMapping(value = "/listAdminThingApi", method = RequestMethod.GET)
    public APIResponse listAdminThingApi(String keyword){
        List<Thing> list =  service.getAdminThingList(keyword);
