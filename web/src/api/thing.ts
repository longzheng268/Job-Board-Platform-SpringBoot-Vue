...
enum URL {
    ...
    listAdminThing = '/api/thing/listAdminThingApi',
...
const listAdminThingApi = async (params: any) => get<any>({ url: URL.listAdminThing, params: params, data: {}, headers: {} });
const listUserThingApi = async (params: any) => get<any>({ url: URL.listUserThing, params: params, data: {}, headers: {} });


export { listApi, createApi, updateApi, deleteApi, detailApi, listAdminThingApi, listUserThingApi};
