<template>
  <div class="content-list">
      ...
      <div class="order-item-view" v-for="(item, index) in postData" :key="index">
        ...
        <div class="bottom flex-view">
          ...
          <div class="right flex-view">
            ...
            <span class="open" @click="handleResume(item.userId)">简历</span>
    ...
    <a-modal v-model:visible="visible" title="简历" @ok="handleOk">
      <a-descriptions title="" bordered :column="{ xxl: 1, xl: 1, lg: 1, md: 1, sm: 1, xs: 1 }">
        ...
        <a-descriptions-item label="教育水平">{{detailData.education}}</a-descriptions-item>
        ...
        <a-descriptions-item label="学校">{{detailData.school}}</a-descriptions-item>
      </a-descriptions>
    </a-modal>
  </div>
</template>
...
import {detailApi} from '/@/api/resume'
